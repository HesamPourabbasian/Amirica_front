<template>
  <!-- Topbar -->
  <div class="h-[80px] bg-gradient-to-b bg-gradient-to-b from-pink-900 via-pink-900 to-pink-900 flex items-center px-6"></div>

  <!-- Grid Layout -->
  <div class="grid grid-cols-5 min-h-screen bg-gradient-to-b from-pink-900 via-purple-900 to-purple-950 text-white">
